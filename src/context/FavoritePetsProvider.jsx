...
const FavoritePetsContext = createContext();

export const useFavoritePetsContext = () => useContext(FavoritePetsContext);

export default function FavoritePetsProvider ({ children }) {
  const { user } = useAuth();
  const { id } = useParams(); 
