...
export default function Cursor() {
  ...
  return (
    <>
      <div
        className="cursor-tail fixed w-2 h-2 rounded-full transition-all duration-100"
        style={{
          transform: `translate3d(${cursorPosition.x}px, ${cursorPosition.y}px, 0)`,
        }}
      ></div>
      <div
        className="cursor-dot fixed w-1 h-1 rounded-full transition-all duration-100"
        style={{
